//function that checks if the the right and left diagonals of a matrice are even. If they are it prints everything except the diagonals themselves
// as the even sum of all diagonals. 
